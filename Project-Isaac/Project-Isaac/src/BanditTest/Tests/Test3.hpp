...
class Test3 : public BanditTest {
public:
    explicit Test3(int n)
        : BanditTest(std::make_shared<BanditPool>(std::initializer_list{
                std::shared_ptr<Bandit>(new Bandit(0.01, "American")),
                std::shared_ptr<Bandit>(new Bandit(0.05, "Ben")),
                std::shared_ptr<Bandit>(new Bandit(0.07, "Cain")),
                std::shared_ptr<Bandit>(new Bandit(0.10, "Daria")),
                std::shared_ptr<Bandit>(new Bandit(0.13, "Eddy")),
                std::shared_ptr<Bandit>(new Bandit(0.15, "Fiona")),
                std::shared_ptr<Bandit>(new Bandit(0.22, "George")),
                std::shared_ptr<Bandit>(new Bandit(0.25, "Henk")),
                std::shared_ptr<Bandit>(new Bandit(0.30, "Inna")),
                std::shared_ptr<Bandit>(new Bandit(0.20, "John")),
            }
        ), n) {
