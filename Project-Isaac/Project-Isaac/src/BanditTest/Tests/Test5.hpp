...
class Test5 : public BanditTest {
public:
    explicit Test5(int n)
        : BanditTest(std::make_shared<BanditPool>(std::initializer_list{
                std::shared_ptr<Bandit>(new Bandit(0.007, "Ann")),
                std::shared_ptr<Bandit>(new Bandit(0.015, "Bill")),
                std::shared_ptr<Bandit>(new Bandit(0.005, "Carl")),
                std::shared_ptr<Bandit>(new Bandit(0.010, "Dori")),
                std::shared_ptr<Bandit>(new Bandit(0.012, "Edgar")),
                std::shared_ptr<Bandit>(new Bandit(0.020, "Fatima")),
                std::shared_ptr<Bandit>(new Bandit(0.002, "Gracie"))
         }
        ), n) {
