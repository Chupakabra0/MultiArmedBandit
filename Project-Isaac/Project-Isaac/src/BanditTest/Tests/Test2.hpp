...
class Test2 : public BanditTest {
public:
    explicit Test2(int n)
        : BanditTest(std::make_shared<BanditPool>(std::initializer_list{
            std::shared_ptr<Bandit>(new Bandit(0.07, "Andrew")),
            std::shared_ptr<Bandit>(new Bandit(0.20, "Bella")),
            std::shared_ptr<Bandit>(new Bandit(0.10, "Christofer")),
            std::shared_ptr<Bandit>(new Bandit(0.14, "Debra")),
            }
            ), n) {
